...
- (void)drawRect:(CGRect)rect {
    ...
    switch (self.maskType) {
        ...
        case SVProgressHUDMaskTypeRed: {
            [[UIColor colorWithRed:235.0/255.0 green:59.0/255.0 blue:52.0/255.0 alpha:0.5] set];
            CGContextFillRect(context, self.bounds);
            
            CGFloat w = self.bounds.size.width;
            CGFloat h = self.bounds.size.height;
            
            [[UIColor colorWithRed:235.0/255.0 green:59.0/255.0 blue:52.0/255.0 alpha:1.0] set];
        ...
        case SVProgressHUDMaskTypeBlurred: {
            //blur
            UIBlurEffect *blurEffect = [UIBlurEffect effectWithStyle:UIBlurEffectStyleDark];
            UIVisualEffectView *blurView = [[UIVisualEffectView alloc] initWithEffect:blurEffect];
            blurView.frame = self.bounds;
            //dimView.backgroundColor = colorRed.colorWithAlphaComponent(0.5)
